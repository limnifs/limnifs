...
|---|---|---|---|---|
| 01 | [Metadata blob: zstd instead of Brotli](01-metadata-zstd.md) | P0 | 1h | Ratio + Speed |
| 02 | [Wire CachedSlabStore into CLI](02-wire-cached-slabstore.md) | P0 | 2h | Read speed |
| 03 | [Multi-profile benchmark](03-multi-profile-benchmark.md) | P0 | 3h | Benchmarking |
| 04 | [Per-profile inline_threshold](04-inline-threshold-tuning.md) | P1 | 1h | Ratio (tiny-files) |
| 05 | [posix_fadvise prefetch on slab files](05-slab-prefetch.md) | P1 | 2h | Read speed |
| 06 | [FastCDC SIMD gear hash](06-fastcdc-simd.md) | P1 | 3d | Create speed |
| 07 | [Parallel slab assembly](07-parallel-slab-assembly.md) | P2 | 2d | Create speed |
| 08 | [Categorizer early-exit optimisation](08-categorizer-early-exit.md) | P1 | 1h | Create speed |
